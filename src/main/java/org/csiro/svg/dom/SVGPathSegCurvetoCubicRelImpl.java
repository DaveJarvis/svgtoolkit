// SVGPathSegCurvetoCubicRelImpl.java
//
/*****************************************************************************
 ...
 *****************************************************************************/
//
// $Id: SVGPathSegCurvetoCubicRelImpl.java,v 1.5 2000/11/21 05:57:03 bella Exp $
//
...
public class SVGPathSegCurvetoCubicRelImpl extends SVGPathSegImpl implements
  ...
  public String toString() {
    return getPathSegTypeAsLetter() + " " + getX1() + " " + getY1() + " "
                + getX2() + " " + getY2() + " "
                + getX() + " " + getY();
  }
   ...
   * @param lastControlPoint Only used for Smooth bezier curves
   */
  ...
  private void calculatePoints(SVGPoint startPoint) {
    ...
    float controlPoint1X = getX1() + startPointX;
    float controlPoint1Y = getY1() + startPointY;
