 ...
 *****************************************************************************/
//
// $Id: SVGRectElementImpl.java,v 1.45 2000/11/29 07:03:44 bella Exp $
//
...
public class SVGRectElementImpl extends SVGGraphic implements SVGRectElement, Drawable, BasicShape {
  ...
  /**
   * Simple constructor, rect initialized to: x=0, y=0, width=0, height=0, rx=0, ry=0.
   */
   ...
   * objects should be recreated. Set this to true if the rect has changed
