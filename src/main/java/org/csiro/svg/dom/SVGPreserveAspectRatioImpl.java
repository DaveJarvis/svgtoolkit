// SVGPreserveAspectRatioImpl.java
//
/*****************************************************************************
 ...
 *****************************************************************************/
//
// $Id: SVGPreserveAspectRatioImpl.java,v 1.8 2000/09/26 14:10:32 dino Exp $
//
...
/**
 * SVGPreserveAspectRatioImpl is the implementation of org.w3c.dom.svg.SVGPreserveAspectRatio
 */
public class SVGPreserveAspectRatioImpl implements SVGPreserveAspectRatio {
  ...
  /**
   * Constructs a new SVGPreserveAspectRatioImpl. The align attribute is initialized
   * to SVG_PRESERVEASPECTRATIO_NONE and meetOrSlice is initialized to SVG_MEETORSLICE_MEET.
   */
   ...
   * SVG_PRESERVEASPECTRATIO constants.
   * @param align The value to set the alginment to.
   */
  ...
  /**
   * Returns the meetOrSlice value as specified by one of the
   * SVG_MEETORSLICE constants.
  ...
  /**
   * Sets the meetOrSlice value as specified by one of the
   * SVG_MEETORSLICE constants.
   * @param meetOrSlice The value to set the meetOrSlice to.
   */
  ...
  public static short getAlignConst(String alignString) {
    ...
    System.out.println("Cannot decode preserveAspectRatio align value: " + alignString);
    return SVG_PRESERVEASPECTRATIO_NONE;
  }
  ...
  public static String getAlignString(short align) {
    switch (align) {
      case SVG_PRESERVEASPECTRATIO_NONE: return "none";
      case SVG_PRESERVEASPECTRATIO_XMINYMIN: return "xMinYMin";
      case SVG_PRESERVEASPECTRATIO_XMIDYMIN: return "xMidYMin";
      case SVG_PRESERVEASPECTRATIO_XMAXYMIN: return "xMaxYMin";
      case SVG_PRESERVEASPECTRATIO_XMINYMID: return "xMinYMid";
      case SVG_PRESERVEASPECTRATIO_XMIDYMID: return "xMidYMid";
      case SVG_PRESERVEASPECTRATIO_XMAXYMID: return "xMinYMax";
      case SVG_PRESERVEASPECTRATIO_XMINYMAX: return "xMidYMax";
      case SVG_PRESERVEASPECTRATIO_XMIDYMAX: return "xMidYMax";
      case SVG_PRESERVEASPECTRATIO_XMAXYMAX: return "xMaxYMax";
  ...
  public static String getMeetOrSliceString(short meetOrSlice) {
    switch (meetOrSlice) {
      case SVG_MEETORSLICE_MEET: return "meet";
      case SVG_MEETORSLICE_SLICE: return "slice";
      default: return "meet";
    }
  }
