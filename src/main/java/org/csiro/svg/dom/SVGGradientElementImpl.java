 ...
 *****************************************************************************/
//
// $Id: SVGGradientElementImpl.java,v 1.23 2001/05/09 01:34:49 bella Exp $
//
...
/**
 * SVGGradientElementImpl is the implementation of org.w3c.dom.svg.SVGGradientElement
 */
public abstract class SVGGradientElementImpl extends SVGStylableImpl implements
  SVGGradientElement {
  ...
  public SVGGradientElementImpl( SVGDocumentImpl owner, org.w3c.dom.Element elem, String name) {
  ...
  public SVGAnimatedEnumeration getSpreadMethod() {
    if (spreadMethod == null) {
      ...
      if (refGradient != null) {
        ...
        spreadMethod = new SVGAnimatedEnumerationImpl(SVG_SPREADMETHOD_PAD, this, spreadMethodStrings, spreadMethodValues);
      }
    }
    return spreadMethod;
  }
  ...
  private void setAttributeValue(String name, String value) {
    if (name.equalsIgnoreCase("gradientUnits")) {
      if (value.equalsIgnoreCase("userSpaceOnUse")) {
        ...
        System.out.println("invalid value '" + value + "' for gradientUnits attribute, setting to default 'objectBoundingBox'");
        getGradientUnits().setBaseVal(SVG_UNIT_TYPE_OBJECTBOUNDINGBOX);
      }
      ...
      ((SVGAnimatedTransformListImpl)getGradientTransform()).setBaseVal(SVGTransformListImpl.createTransformList(value));
  ...
  protected Color getColorAtOffset(double offset) {
    ...
    if (stopBefore != null && stopAfter == null)  // only one stop, just return it's color
  ...
  public SVGStopElementImpl getStop(int index) {
    ...
    } else { // see if there is a referenced gradient and if it has the required stop element
      SVGGradientElementImpl refGradient = getReferencedGradient();
      if (refGradient != null) {
