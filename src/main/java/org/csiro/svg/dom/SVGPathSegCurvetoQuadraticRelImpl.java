// SVGPathSegCurvetoQuadraticRelImpl.java
//
/*****************************************************************************
 ...
 *****************************************************************************/
//
// $Id: SVGPathSegCurvetoQuadraticRelImpl.java,v 1.5 2000/11/21 05:57:03 bella Exp $
//
...
/**
  ...
  private void calculatePoints(SVGPoint startPoint) {
    ...
    float controlPointX = getX1() + startPoint.getX();
    float controlPointY = getY1()  + startPoint.getY();
    float endPointX = getX() + startPoint.getX();
    float endPointY = getY() + startPoint.getY();
