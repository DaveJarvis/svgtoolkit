 ...
 *****************************************************************************/
//
// $Id: SVGPolylineElementImpl.java,v 1.46 2000/11/29 07:03:44 bella Exp $
//
...
/**
 * SVGPolylineElementImpl is the implementation of org.w3c.dom.svg.SVGPolylineElement
 */
public class SVGPolylineElementImpl extends SVGGraphic implements
  SVGPolylineElement, Drawable, BasicShape {
   ...
   * objects should be recreated. Set this to true if the polyline has changed
  ...
  public void draw(Graphics2D graphics, boolean refreshData) {
    ...
    if (refreshData || polyline == null) { // regenerate all of the shapes and painting objects
