 ...
 *****************************************************************************/
//
// $Id: SVGCircleElementImpl.java,v 1.40 2000/11/29 07:03:40 bella Exp $
//
...
/**
 * SVGCircleElementImpl is the implementation of org.w3c.dom.svg.SVGCircleElement
 */
public class SVGCircleElementImpl extends SVGGraphic implements
  SVGCircleElement, Drawable, BasicShape {
  ...
  /**
   * Simple constructor, cx, cy and r attributes are initialized to 0
   */
  public SVGCircleElementImpl(SVGDocumentImpl owner) {
    super(owner, "circle");
   ...
   */
  public SVGCircleElementImpl(SVGDocumentImpl owner, Element elem) {
    super(owner, elem, "circle");
  }

  public SVGElementImpl cloneElement() {
    SVGCircleElementImpl newCircle = new SVGCircleElementImpl(getOwnerDoc(), this);

    // need to copy any animation references into new circle
    ...
    if (cxAnims != null) {
      for (int i = 0; i < cxAnims.size(); i++) {
        ...
        newCircle.attachAnimation(anim);
      }
    }
    if (cyAnims != null) {
    ...
    if (animatedProperties != null) {
      newCircle.animatedProperties = animatedProperties;
    }
    return newCircle;
  }
   ...
   * @return The r attribute.
   */
  public SVGAnimatedLength getR() {
    if (r == null)  {
      r = new SVGAnimatedLengthImpl(new SVGLengthImpl(0, this, SVGLengthImpl.NO_DIRECTION), this);
    }
    return r;
  }
   ...
   * objects should be recreated. Set this to true if the circle has changed
  ...
  public void draw(Graphics2D graphics, boolean refreshData) {
    ...
    if (refreshData || shape == null) { // regenerate all of the shapes and painting objects
  ...
  /**
   * Returns a Shape object that represents this circle element. No
   * transformations are applied to the circle.
   */
  public Shape getShape() {
    if (shape == null) {
      // create the shape, ctm is used for determining lengths that have specified
