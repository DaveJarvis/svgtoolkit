 ...
 *****************************************************************************/
//
// $Id: SVGPathSegClosePathImpl.java,v 1.5 2000/11/28 06:09:58 cath Exp $
//
...
public class SVGPathSegClosePathImpl extends SVGPathSegImpl implements
   ...
   * Returns the length of this path segment.
   * @param startPoint The starting point for this segment.
   * @param lastPoint The last point for this close path segment, need to
   *                  pass it in rather than the lastControlPoint as it isn't an attribute.
   */
   ...
   * @param startPoint The starting point for this segment.
   * @param lastPoint The last point of this segment.
   */
