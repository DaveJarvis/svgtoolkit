 ...
 *****************************************************************************/
//
// $Id: SVGEllipseElementImpl.java,v 1.38 2000/11/29 07:03:41 bella Exp $
//
...
/**
 * SVGEllipseElementImpl is the implementation of org.w3c.dom.svg.SVGEllipseElement
 */
public class SVGEllipseElementImpl extends SVGGraphic implements
  SVGEllipseElement, Drawable, BasicShape {
  ...
  public SVGAnimatedLength getRx() {
    if (rx == null) {
      if (ry != null) {
        rx = new SVGAnimatedLengthImpl(new SVGLengthImpl(ry.getBaseVal().getValueAsString(), this, SVGLengthImpl.X_DIRECTION), this);
      } else {
  ...
  public SVGAnimatedLength getRy() {
    if (ry == null) {
      if (rx != null) {
        ry = new SVGAnimatedLengthImpl(new SVGLengthImpl(rx.getBaseVal().getValueAsString(), this, SVGLengthImpl.Y_DIRECTION), this);
      } else {
   ...
   * objects should be recreated. Set this to true if the ellipse has changed
