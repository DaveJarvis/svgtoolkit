 ...
 *****************************************************************************/
//
// $Id: SVGMatrixImpl.java,v 1.11 2000/09/26 14:10:27 dino Exp $
//
...
/**
 * SVGMatrixImpl is the implementation of org.w3c.dom.svg.SVGMatrix
 * It represents a matrix in the form:
 *      [a c e]
 *      [b d f]
 *      [0 0 1]
 */
public class SVGMatrixImpl implements SVGMatrix {
   ...
   * @param a The value to set the a component to.
   */
   ...
   * @param b The value to set the b component to.
   */
   ...
   * @param c The value to set the c component to.
   */
   ...
   * @param d The value to set the d component to.
   */
   ...
   * @param e The value to set the e component to.
   */
   ...
   * @param f The value to set the f component to.
   */
  ...
  public SVGMatrix inverse() throws SVGException {
    ...
    try {
      ...
      throw new SVGExceptionImpl(SVGException.SVG_MATRIX_NOT_INVERTABLE,
   ...
   *         SVG_WRONG_TYPE_ERR if one of the parameters is of the wrong type.
   */
  ...
  */
   ...
   * returns the resulting matrix. The rotation angle is determined by
   * taking (+/-) atan(y/x). The direction of the vector (x,y) determines
   ...
   * @return The resulting matrix.
   * @exception SVGException
   *         SVG_INVALID_VALUE_ERR if one of the parameters has an invalid value.
   */
  ...
  public SVGMatrix skewX(float angle) {
    SVGMatrixImpl result = new SVGMatrixImpl(this);
    result.transform.concatenate(
        new AffineTransform(1, 0, Math.tan(Math.toRadians(angle)), 1, 0, 0));
    return result;
  ...
  public SVGMatrix skewY(float angle) {
    SVGMatrixImpl result = new SVGMatrixImpl(this);
    result.transform.concatenate(
        new AffineTransform(1, Math.tan(Math.toRadians(angle)), 0, 1, 0, 0));
    return result;
  }
