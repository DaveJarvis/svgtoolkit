 ...
 *****************************************************************************/
//
// $Id: SVGGraphic.java,v 1.31 2000/11/21 05:56:59 bella Exp $
//
 ...
 * SVGStylable, SVGTransformable, SVGLangSpace, SVGTests, EventTarget and SVGExternalResourcesRequired.
 */
public abstract class SVGGraphic extends SVGTransformableImpl
       implements SVGLangSpace, SVGTests, EventTarget,
  ...
  public void setAttribute(String name, String value) {
    ...
    if (name.equalsIgnoreCase("onfocusin")
