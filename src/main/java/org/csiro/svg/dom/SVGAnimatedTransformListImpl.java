 ...
 *****************************************************************************/
//
// $Id: SVGAnimatedTransformListImpl.java,v 1.10 2000/12/13 14:26:51 dino Exp $
//
...
/**
 * SVGAnimatedTransformListImpl is the implementation of org.w3c.dom.svg.SVGAnimatedTransformList
 */
public class SVGAnimatedTransformListImpl extends SVGAnimatedValue implements
    ...
    if (animations == null) {
      ...
      for (int i = 0; i < numAnimations; i++) {
        ...
        if (animation instanceof SVGAnimateTransformElement ) {
          SVGTransformListImpl animVal = (SVGTransformListImpl)animation.getCurrentValue(ANIMTYPE_TRANSFORMLIST);
          if (animVal != null) {
        ...
        if (animation instanceof SVGAnimateMotionElement ) {
          ...
          if (animVal != null) {
            if (animation.getAttribute("additive").equals("replace")) {
              ...
              motionTransform = (SVGTransformListImpl)SVGTransformListImpl.createTransformList(transformString);
            }
          }
        }
      }
      ...
      return (SVGTransformListImpl)SVGTransformListImpl.createTransformList(transformString);
    }
  }
} 
