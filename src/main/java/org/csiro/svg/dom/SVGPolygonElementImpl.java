 ...
 *****************************************************************************/
//
// $Id: SVGPolygonElementImpl.java,v 1.44 2000/11/29 07:03:44 bella Exp $
//
...
/**
 * SVGPolygonElementImpl is the implementation of org.w3c.dom.svg.SVGPolygonElement
 */
public class SVGPolygonElementImpl extends SVGGraphic implements
  SVGPolygonElement, Drawable, BasicShape {
   ...
   * Simple constructor
   */
  public SVGPolygonElementImpl(SVGDocumentImpl owner) {
    super(owner, "polygon");
   ...
   */
  public SVGPolygonElementImpl(SVGDocumentImpl owner, Element elem) {
    super(owner, elem, "polygon");
  }

  public SVGElementImpl cloneElement() {
    SVGPolygonElementImpl newPolygon = new SVGPolygonElementImpl(getOwnerDoc(), this);
    ...
    if (pointsAnims != null) {
      for (int i = 0; i < pointsAnims.size(); i++) {
        ...
        newPolygon.attachAnimation(anim);
      }
    }
    ...
    if (animatedProperties != null) {
      newPolygon.animatedProperties = animatedProperties;
    }
    return newPolygon;
   ...
   * objects should be recreated. Set this to true if the polygon has changed
  ...
  public void draw(Graphics2D graphics, boolean refreshData) {
    ...
    if (refreshData || polygon == null) { // regenerate all of the shapes and painting objects
      ...
      if (fillRule.equalsIgnoreCase("nonzero")) {
        polygon.setWindingRule(GeneralPath.WIND_NON_ZERO);
      } else {
        polygon.setWindingRule(GeneralPath.WIND_EVEN_ODD);
      }
    ...
    if (visible && display && opacity > 0) {
      ...
      if (opacity < 1) {
        ...
        if (imageWidth > 0 && imageHeight > 0) {
          ...
          // draw polygon to offscreen buffer
