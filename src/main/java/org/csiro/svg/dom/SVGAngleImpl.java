 ...
 *****************************************************************************/
//
// $Id: SVGAngleImpl.java,v 1.12 2000/09/26 14:10:17 dino Exp $
//
...
public class SVGAngleImpl implements SVGAngle {
   ...
   * @param valueAndUnit The String representation of the angle. eg. 90deg
   */
   ...
   * attribute will cause valueInSpecifiedUnits and valueAsString to be updated
   * automatically to reflect this setting.
   * @param value Value to assign to angle.
   */
  ...
  /**
   * Returns the angle value as a floating point value, in the units expressed by
   * unitType.
  ...
  /**
   * Sets the angle value in the units expressed by unitType.
   * Setting this attribute will cause value and valueAsString to be
   * updated automatically to reflect this setting.
   * @param valueInSpecifiedUnits  Value to assign to valueInSpecifiedUnits.
   */
   ...
   * updated automatically to reflect this setting.
   * @param valueAsString  Value to assign to valueAsString.
   */
  ...
  /**
   * Reset the value as a number with an associated unitType, thereby replacing
   * the values for all of the attributes on the object.
  ...
  public void convertToSpecifiedUnits(short unitType) throws SVGException {
    checkUnitType(unitType);
    this.unitType = unitType;
    setValue(value);  // will cause valueInSpecifiedUnits and valueAsString to be updated
  }

  /**
   * Checks if the given unit type is a valid one. Note: SVG_ANGLETYPE_UNKNOWN is invalid.
   * If not, throws an SVGException.
   * @param unitType The unit type to check.
   */
  private void checkUnitType(short unitType) throws SVGException {
    if (! (unitType == SVG_ANGLETYPE_DEG
   ...
   * @param unitType The unitType of the given angle value.
   ...
   * @param value The angle value (in degrees) to convert.
   * @param unitType The unit type to convert to.
   ...
   * @param cssText The CSS angle text used to set this angle. eg. "2rad"
   */
   ...
   * @param unit A unit type constant.
   * @return The string representation of the unit type.
   */
  private static String getUnitText(short unit) {
    switch (unit) {
      case SVG_ANGLETYPE_DEG: return "deg";
      case SVG_ANGLETYPE_GRAD: return "grad";
      case SVG_ANGLETYPE_RAD: return "rad";
      case SVG_ANGLETYPE_UNKNOWN: return "";
      case SVG_ANGLETYPE_UNSPECIFIED: return "";
      default: return "";
    }
  }

  /**
   * Returns the unit type constant that represents the given unit type string.
   * @param unit A unit type string.
   * @return The unit type constant that represents the unit type string.
   */
  private static short getUnitTypeConst(String unit) {
    if (unit == null) {
      return SVG_ANGLETYPE_UNSPECIFIED;  // assume that the unit wasn't specified
    }
