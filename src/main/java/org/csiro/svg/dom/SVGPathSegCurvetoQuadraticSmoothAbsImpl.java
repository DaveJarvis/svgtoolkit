 ...
 *****************************************************************************/
//
// $Id: SVGPathSegCurvetoQuadraticSmoothAbsImpl.java,v 1.5 2000/11/21 05:57:04 bella Exp $
//
...
/**
   ...
   * @param startPoint The starting point for this segment.
   * @param lastControlPoint of the previous curve, used to determine first control point.
   */
 ...
 //   double ratio = (distance-seglength[left])/seglength[left];
  ...
  private void calculatePoints(SVGPoint startPoint,SVGPoint lastControlPoint) {
    ...
    float controlPointX = 2*startPoint.getX() - (float)lastControlPoint.getX();
    float controlPointY = 2*startPoint.getY() - (float)lastControlPoint.getY();
