 ...
 *****************************************************************************/
//
// $Id: SVGAngleListImpl.java,v 1.3 2000/11/21 05:56:55 bella Exp $
//
...
public class SVGAngleListImpl extends SVGListImpl {
  ...
  public SVGAngle initialize ( SVGAngle newItem)
                  throws DOMException, SVGException {
    return (SVGAngle)super.initialize(newItem);
  }

  public SVGAngle getItem ( int index )
                  throws DOMException {
    return (SVGAngle)super.getItemAt(index);
  }

  public SVGAngle insertItemBefore ( SVGAngle newItem, int index )
                  throws DOMException, SVGException {
    return (SVGAngle)super.insertItemBefore(newItem, index);
  }

  public SVGAngle replaceItem ( SVGAngle newItem, int index )
                  throws DOMException, SVGException {
    return (SVGAngle)super.replaceItem(newItem, index);
  }

  public SVGAngle removeItem ( int index )
                  throws DOMException {
    return (SVGAngle)super.removeItemAt(index);
  }

  public SVGAngle appendItem ( SVGAngle newItem )
                  throws DOMException, SVGException {
  ...
  public String toString() {
    ...
    for (int i = 0; i < numAngles; i++) {
      SVGAngle angle = (SVGAngle)getItem(i);
