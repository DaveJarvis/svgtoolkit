 ...
 *****************************************************************************/
//
// $Id: SVGAnimateTransformElementImpl.java,v 1.7 2000/11/30 03:08:30 bella Exp $
//
...
public class SVGAnimateTransformElementImpl extends SVGAnimationElementImpl implements
  ...
  private SVGTransformList getCurrentTransform( float percentageComplete, String from, String to, String by, String type) {
      ...
      if (from.length() > 0) {
        ...
        if (to.length() > 0) { // is a from-to anim
          ...
          String transformString = "rotate(" + (angleFrom + percentageComplete * angleBy) + ", " +
                                             (cxFrom + percentageComplete * cxBy) + ", " +
                                                (cyFrom + percentageComplete * cyBy) + ")";
          return SVGTransformListImpl.createTransformList(transformString);
        }
      }
