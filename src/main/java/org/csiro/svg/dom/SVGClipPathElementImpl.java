 ...
 *****************************************************************************/
//
// $Id: SVGClipPathElementImpl.java,v 1.21 2000/11/22 05:00:10 bella Exp $
//
...
/**
 * SVGClipPathElementImpl is the implementation of org.w3c.dom.svg.SVGClipPathElement
 */
public class SVGClipPathElementImpl extends SVGTransformableImpl implements
  SVGClipPathElement {
   ...
   */
  public SVGClipPathElementImpl(SVGDocumentImpl owner, org.w3c.dom.Element elem) {
  ...
  public SVGAnimatedEnumeration getClipPathUnits() {
    if (clipPathUnits == null) {
      ...
      clipPathUnits = new SVGAnimatedEnumerationImpl(SVG_UNIT_TYPE_USERSPACEONUSE, this, clipPathUnitStrings, clipPathUnitValues);
    }
  ...
  public SVGRect getBBox() {
    // just use the root element as the element to be clipped for this method
  ...
  public Shape getClippingShape( SVGElement clippedElement) {
          ...
          if (childShape != null) {
            ...
            if (child instanceof SVGTransformable ) {
              ...
              if (childTransform != null) {
                childAffineTransform.concatenate(((SVGTransformListImpl)childTransform.getAnimVal()).getAffineTransform());
              }
            }
    ...
    // see if this clipPath element has a clipPath property, if it does, do intersection
    SVGClipPathElementImpl clipPath = getClippingPath();
    String thisClipRule = getClipRule();
