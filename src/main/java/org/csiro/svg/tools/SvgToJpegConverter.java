 ...
 *****************************************************************************/
//
// $Id: SvgToJpegConverter.java,v 1.6 2000/09/26 14:10:38 dino Exp $
//
...
public class SvgToJpegConverter {
  ...
  private static void convert(String[] args) {
    ...
    try {
      ...
      System.out.println("created jpeg file: " + args[1]);
    } catch (IOException e) {
  ...
  public static void main(String[] args) {
    ...
    if (!(args.length == 2 || args.length == 4 || args.length == 8)) {
      System.out.println("usage: java org.csiro.svg.tools.SvgToJpegConverter " +
        "infile.svg outfile.jpg [width height [viewX viewY viewWidth viewHeight]]");
      System.exit(1);
    }
    SvgToJpegConverter.convert(args);
    System.exit(0);
  }
}
