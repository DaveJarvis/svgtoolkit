 ...
 *****************************************************************************/
//
// $Id: ScriptMouseHandler.java,v 1.10 2002/03/11 23:46:52 bella Exp $
//
...
public class ScriptMouseHandler extends MouseHandler {
  ...
  public void mouseClicked(MouseEvent e) {
    if (getCanvas().getSVGDocument() != null) {
      Vector elementsClickedOn = getCanvas().getSVGDocument().getElementsThatContain(
      ...
      if (numElements > 0) {
        for (int i = numElements-1; i >= 0; i--) {
          ...
          clickEvent.initMouseEvent("onclick", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
          ...
          if (!activeElements.contains(element)) {
            ...
            activateEvent.initMouseEvent("onactivate", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
                              // (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
                               (int)e.getX(), (int)e.getY(),
                               false, false, false, false, (short)0, null);
          ...
          // if there are any elements that have been clicked on that didn't have focus last click dispatch onfocusin event
          if (!lastFocusElements.contains(element)) {
            MouseEventImpl focusInEvent = (MouseEventImpl)svg.createEvent("MouseEvent");
            focusInEvent.initMouseEvent("onfocusin", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
                              // (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
                               (int)e.getX(), (int)e.getY(),
                               false, false, false, false, (short)0, null);
      ...
      // if there are any elements that had focus before this click and they don't have it now dispatch onfocusout event
      for (int i = 0; i < lastFocusElements.size(); i++) {
        ...
        if (!elementsClickedOn.contains(element)) {
          ...
          focusOutEvent.initMouseEvent("onfocusout", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
                            // (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
                             (int)e.getX(), (int)e.getY(),
                             false, false, false, false, (short)0, null);
  ...
  public void mousePressed(MouseEvent e) {
    if (getCanvas().getSVGDocument() != null) {
      ...
      if (numElements > 0) {
        ...
        event.initMouseEvent("onmousedown", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
          // (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
           (int)e.getX(), (int)e.getY(),
            false, false, false, false, (short)0, null);
  ...
  public void mouseReleased(MouseEvent e) {
    if (getCanvas().getSVGDocument() != null) {
      ...
      if (numElements > 0) {
        ...
        event.initMouseEvent("onmouseup", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
          // (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
           (int)e.getX(), (int)e.getY(),
            false, false, false, false, (short)0, null);
  ...
  public void mouseEntered(MouseEvent e) {
    if (getCanvas().getSVGDocument() != null) {
      ...
      // bodgy code to dispatch the event listener to the top-most svg element...
      SVGSVGElement svg = getCanvas().getSVGDocument().getRootElement();
  ...
  public void mouseDragged(MouseEvent e) {
    if (getCanvas().getSVGDocument() != null) {
      Vector elementsUnderMouse = getCanvas().getSVGDocument().getElementsThatContain(
             ((WorldMouseEvent)e).getWorldX() , ((WorldMouseEvent)e).getWorldY());
      ...
      if (numElements > 0) {
        ...
        event.initMouseEvent("onmousemove", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
         //  (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
           (int)e.getX(), (int)e.getY(),
            false, false, false, false, (short)0, null);
   ...
   * when there are no buttons pressed.  Generates onmouseover, onmousemove
  ...
  public void mouseMoved ( MouseEvent e ) {
    if (getCanvas().getSVGDocument() != null) {
      ...
      // see if there are any elements in lastElementsUnder that aren't still under the mouse
      for (int i = 0; i < lastElementsUnder.size(); i++) {
        if (!elementsUnderMouse.contains(lastElementsUnder.elementAt(i))) {
          ...
          MouseEventImpl event = (MouseEventImpl)svg.createEvent("MouseEvent");
          event.initMouseEvent("onmouseout", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
         //    (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
             (int)e.getX(), (int)e.getY(),
              false, false, false, false, (short)0, null);
      ...
      // see if there are any new elements under the mouse
       for (int i = 0; i < elementsUnderMouse.size(); i++) {
        if (!lastElementsUnder.contains(elementsUnderMouse.elementAt(i))) {
          ...
          MouseEventImpl event = (MouseEventImpl)svg.createEvent("MouseEvent");
          event.initMouseEvent("onmouseover", false, false, canvas, (short)0, (int)e.getX(), (int)e.getY(),
           //  (float)((WorldMouseEvent)e).getWorldX() , (float)((WorldMouseEvent)e).getWorldY(),
             (int)e.getX(), (int)e.getY(),
              false, false, false, false, (short)0, null);
          EventTarget element = (EventTarget)elementsUnderMouse.elementAt(i);
