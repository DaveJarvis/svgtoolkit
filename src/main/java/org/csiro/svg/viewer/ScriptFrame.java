 ...
 *****************************************************************************/
//
// $Id: ScriptFrame.java,v 1.2 2000/09/26 14:10:39 dino Exp $
//
...
*/
  ...
  private void jbInit() throws Exception
  {
    ...
    inputTextScrollPanel.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
    inputTextScrollPanel.setAutoscrolls(true);
    outputTextScrollPanel.setAutoscrolls(true);
    outputTextScrollPanel.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
  ...
  {
    //System.out.println("About to execute script: " + this.inputTextArea.getText());
  }
