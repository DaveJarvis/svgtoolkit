 ...
 *****************************************************************************/
//
// $Id: ScriptController.java,v 1.4 2002/02/21 07:46:09 brett Exp $
//
...
public class ScriptController {
  ...
  public void exposeObjectToScriptEngine(String name, Object o) {
    System.out.println("ScriptController about to expose '" + name + "' to ScriptController engine as " + o.toString());
    Scriptable jsArgs = getContext().toObject(o,getScope());
  ...
  public Object execute(String commandString) {
    ...
    try {
      ...
      result = getContext().toString(result);
