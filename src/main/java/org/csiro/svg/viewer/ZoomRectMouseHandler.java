 ...
 *****************************************************************************/
//
// $Id: ZoomRectMouseHandler.java,v 1.3 2000/09/26 14:10:40 dino Exp $
//
...
/**
 * ZoomRectMouseHandler is a mouse handler that will ZoomRect the display as the user
  ...
  public void mouseDragged(MouseEvent e) {
    ...
    if (!e.isMetaDown()) {
      ...
      if (previous != null) {
        ...
        if (newWidth > 0) {
          previous.x = pressedX;
          if (newWidth < canvasDimensions.width / 10) newWidth = canvasDimensions.width / 10;
        } else {
          if ((-1 * newWidth) < canvasDimensions.width / 10) newWidth = canvasDimensions.width / -10;
        }
        if (newHeight > 0) {
          if (newHeight < canvasDimensions.height / 10) newHeight = canvasDimensions.height / 10;
        } else {
          if ((-1 * newHeight) < canvasDimensions.height / 10) newHeight = canvasDimensions.height / -10;
        }
