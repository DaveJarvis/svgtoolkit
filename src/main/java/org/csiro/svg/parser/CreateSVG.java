 ...
 *****************************************************************************/
//
// $Id: CreateSVG.java,v 1.9 2000/11/30 05:37:39 bella Exp $
//
...
public class CreateSVG {
  ...
  public static void main(String[] args) {
    ...
    try {
      SVGDocument svgDoc = new SVGDocumentImpl();
      ...
      // need to pass in the doctype declaration so that it can be put at the top of the xml file
