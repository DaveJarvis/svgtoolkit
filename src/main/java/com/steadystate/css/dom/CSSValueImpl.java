 ...
 *
 * $Id: CSSValueImpl.java,v 1.1 2002/02/21 08:19:02 brett Exp $
 */

 /*
  * This file was modified by the CSIRO SVG team on 19/2/2002.
  *
  * The getValueType() method was changed to getCssValueType() in order to comply
  * with the SVG DOM specification binding.
  *
  * svg@cmis.csiro.au
  */
 ...
 * @version $Release$
 */
public class CSSValueImpl implements org.w3c.dom.css.CSSPrimitiveValue,
...
//                return CSS_RECT;
    ...
    public void setFloatValue(short unitType, float floatValue) throws
      org.w3c.dom.DOMException {
        _value = LexicalUnitImpl.createNumber(null, floatValue);
    }

    public float getFloatValue(short unitType) throws
      org.w3c.dom.DOMException {
        if (_value instanceof LexicalUnit) {
            LexicalUnit lu = (LexicalUnit) _value;
...
//        return 0;
    ...
    public void setStringValue(short stringType, String stringValue) throws
      org.w3c.dom.DOMException {
        switch (stringType) {
        case CSS_STRING:
...
//            break;
     ...
     */
    public String getStringValue() throws org.w3c.dom.DOMException {
        if (_value instanceof LexicalUnit) {
            LexicalUnit lu = (LexicalUnit) _value;
    ...
    public org.w3c.dom.css.Counter getCounterValue() throws
      org.w3c.dom.DOMException {
        if ((_value instanceof org.w3c.dom.css.Counter) == false) {
            throw new DOMExceptionImpl(
              org.w3c.dom.DOMException.INVALID_ACCESS_ERR,
    ...
    public org.w3c.dom.css.Rect getRectValue() throws
      org.w3c.dom.DOMException {
        if ((_value instanceof org.w3c.dom.css.Rect) == false) {
            throw new DOMExceptionImpl(
              org.w3c.dom.DOMException.INVALID_ACCESS_ERR,
              DOMExceptionImpl.RECT_ERROR);
        }
        return (org.w3c.dom.css.Rect) _value;
    }

    public org.w3c.dom.css.RGBColor getRGBColorValue() throws
      org.w3c.dom.DOMException {
        if ((_value instanceof org.w3c.dom.css.RGBColor) == false) {
            throw new DOMExceptionImpl(
              DOMException.INVALID_ACCESS_ERR,
              DOMExceptionImpl.RGBCOLOR_ERROR);
        }
        return (org.w3c.dom.css.RGBColor) _value;
    }
    ...
    public org.w3c.dom.css.CSSValue item( int index) {
        return (_value instanceof Vector)
            ? ((org.w3c.dom.css.CSSValue)((Vector)_value).elementAt( index))
            : null;
    }
