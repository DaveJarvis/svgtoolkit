 ...
 *
 * $Id: MediaListImpl.java,v 1.1 2002/02/21 08:19:02 brett Exp $
 */
...
public class MediaListImpl implements MediaList {
    ...
    private final Vector _media = new Vector();
    ...
    public void setMediaText(String mediaText) throws
...
*/
    ...
    public void deleteMedium(String oldMedium) throws
      org.w3c.dom.DOMException {
        for (int i = 0; i < _media.size(); i++) {
