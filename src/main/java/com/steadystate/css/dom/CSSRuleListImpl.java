 ...
 *
 * $Id: CSSRuleListImpl.java,v 1.1 2002/02/21 08:19:02 brett Exp $
 */
...
public class CSSRuleListImpl implements org.w3c.dom.css.CSSRuleList {
    ...
    public org.w3c.dom.css.CSSRule item( int index) {
        return (_rules != null) ? (org.w3c.dom.css.CSSRule) _rules.elementAt( index) : null;
    }
