 ...
 *
 * $Id: CSSOMParser.java,v 1.1 2002/02/21 08:19:03 brett Exp $
 */
...
public class CSSOMParser {
    ...
    public org.w3c.dom.css.CSSStyleSheet parseStyleSheet( InputSource source) throws IOException {
        CSSOMHandler handler = new CSSOMHandler();
        _parser.setDocumentHandler(handler);
        _parser.parseStyleSheet(source);
        return (org.w3c.dom.css.CSSStyleSheet) handler.getRoot();
    }
    
    public org.w3c.dom.css.CSSStyleDeclaration parseStyleDeclaration( InputSource source)
            throws IOException {
    ...
    public void parseStyleDeclaration( org.w3c.dom.css.CSSStyleDeclaration sd, InputSource source)
            throws IOException {
    ...
    public org.w3c.dom.css.CSSValue parsePropertyValue( InputSource source) throws IOException {
        CSSOMHandler handler = new CSSOMHandler();
        _parser.setDocumentHandler(handler);
        return new CSSValueImpl(_parser.parsePropertyValue(source));
    }
    
    public org.w3c.dom.css.CSSRule parseRule( InputSource source) throws IOException {
        CSSOMHandler handler = new CSSOMHandler();
        _parser.setDocumentHandler(handler);
        _parser.parseRule(source);
        return (org.w3c.dom.css.CSSRule) handler.getRoot();
    }
